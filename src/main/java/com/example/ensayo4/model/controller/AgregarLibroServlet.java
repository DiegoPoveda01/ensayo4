...
import com.example.ensayo4.model.Libro;
import com.example.ensayo4.model.data.DBGenerator;
import com.example.ensayo4.model.data.dao.LibroDAO;
...
public class AgregarLibroServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException  {
        RequestDispatcher respuesta = req.getRequestDispatcher("/registroInvalido.jsp");
